...
on :load do
  ...
  set :copy_exclude, [".git/*", ".bundle/*", "log/*", ".rvmrc", "public/uploads/*", "jetty/*", "tmp/*"]
end

# Use a simple directory tree copy here to make demo easier.
# You probably want to use your own repository for a real app
# TODO: Convert to use git
set :scm, :none
set :repository, "."
set :deploy_via, :copy
...
set :bundle_without, [:development, :test] if ['production', 'staging'].include?(Rubber.env)
